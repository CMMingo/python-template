---
name: lbt
description: Diagnose and improve the user's own explanation through a learning-by-teaching loop. Use when the user types `/lbt` followed by their current understanding, asks to test their understanding in their own words, or wants misconceptions, near-misses, and conflated concepts identified.
